...
(function (K) {
  ...
  const CHANGES = [
    ...
    ['25 Sep 2026', [
      ...
      ['Game systems', [
        'New Spending Points page: VIP, starting gear, titles, rolls, Legacy evolve items.',
      ...
      ['Calculators', [
        'New Run planner (beta): load your save (Legacy, Points, Map Level, title, VIP, World Points) or pick by hand. Only heroes you can pick.',
        ...
        'Next buy line: the VIP or title that pays back, or keep your Points.',
        'No clock times: runs are short / medium / long, farming in kills and Boss Souls.',
        'Fixed: Death N9 offered to a Map Level 26 account, Windmill Village Chief fight rule, +20 stone cost with VIP (VIP 4: about 6,200 Boss Souls).',
